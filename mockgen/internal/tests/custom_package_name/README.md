...
is located under import path "github.com/bitgaming/mock/mockgen/internal/tests/custom_package_name/client/v1".
...
This can be fixed by manually providing `-imports` flag, like `-imports client=github.com/bitgaming/mock/mockgen/internal/tests/custom_package_name/client/v1`.
